...
def main():
    ...
    sub =  rospy.Subscriber('/point_scan', ME439WaypointXYZ, manual_endpoint_location)
    
def manual_endpoint_location(msg_in): 
    while not rospy.is_shutdown(): 
        xyz_goal = msg_in.data
        print(xyz_goal)
        ...
        if xyz_err_norm > 0.001:
            ...
            go_anyway = raw_input('Move to nearest point {} - Y or N?\n')
